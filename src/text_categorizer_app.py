...
class App(tk.Tk):
    ...
    def rnn_simple_categorize(self):
        model = tf.keras.models.load_model('C:/Users/reosk/projects/text-categorizer/saved_models/rnn_simple_1')
    ...
    def rnn_lstm_categorize(self):
        model = tf.keras.models.load_model('C:/Users/reosk/projects/text-categorizer/saved_models/rnn_lstm_4')
    ...
    def decision_tree_categorize(self):
        with open('C:/Users/reosk/projects/text-categorizer/saved_models/decision_tree_model.pkl', 'rb') as file:
    ...
    def ann_categorize(self):
        model = tf.keras.models.load_model('C:/Users/reosk/projects/text-categorizer/saved_models/ann_3')
    ...
    def knn_categorize(self):
        with open('C:/Users/reosk/projects/text-categorizer/saved_models/knn_model.pkl', 'rb') as file:
